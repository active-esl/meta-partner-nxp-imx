...
grep -Fqx 'ExecStartPost=/usr/libexec/waydroid-frdm-device-permissions' "$service"
...
grep -Fq 'chmod 0666 /dev/dma_heap/linux,cma-uncached /dev/dma_heap/system' "$permissions"
